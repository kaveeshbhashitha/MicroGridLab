                ...
                <form class="my-2" method="post" class="col-4" action="{{ url('course') }}" enctype="multipart/form-data">
                    ...
                    <!-- <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" name="faculty" class="form-control" id="inputEmail4" placeholder="Enter instructor name...">
                        </div>
                        <div class="form-group col-md-3">
                            <label for="inputEmail4">University</label>
                            <input type="text" name="university" class="form-control" id="inputEmail4" placeholder="Enter instructor name...">
                        </div>
                        <div class="form-group col-md-3">
                    ...
                    <!-- <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="date" name="nextintake" class="form-control" id="inputCity" placeholder="Enter next intake..">
                        </div>
                        <div class="form-group col-md-3">
                            <label for="inputCity">Telephone</label>
                            <input type="text" name="telephone" class="form-control" id="inputCity" placeholder="Enter telephone number..">
                        </div>
                        <div class="form-group col-md-3">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" name="weburl" class="form-control" id="inputCity" placeholder="Enter any other URL...">
                        </div>
                    </div>
