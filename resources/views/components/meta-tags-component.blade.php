...
<meta property="og:title" content="Micro Grid Lab / Smart Grid Lab" />
<meta property="og:type" content="website" />
<meta property="og:url" content="http://www.yourwebsite.com/" />
<meta property="og:image" content="{{ asset('image/sgrg-logo.png') }}" />
<meta property="og:description" content="Micro Grid Lab / Smart Grid Lab for electrical engineering, smart grid, renewable energy, sustainable energy, power products, AI, and power automation." />
...
<!-- Favicon -->
<link rel="icon" href="{{ asset('image/sgrg-logo.png') }}" type="image/x-icon">
